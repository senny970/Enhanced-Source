...
ECHO "Loading %~1 in FINAL COMPILE"

:: Now take the precached information and use it with the tool exes.
:: Feel Free to edit the prams if needed. This is the final batch. 
:: See Wiki for all the prams.
...
"%SDKDIR%vrad.exe" -final -staticproppolys -both -staticproplighting -textureshadows -game %gamedir% "%~1"
